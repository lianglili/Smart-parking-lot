...
class ArtExMonitor(Frame):
    ...
    def createWidget(self):
        ...
        self.lbExit_number_plate.place(relx=0.5,rely=0,relwidth=0.25,relheight=0.2)
        #
        self.etExit_number_plate = Entry(self,fg='black',font=('微软雅黑',18),state='normal')
        self.etExit_number_plate.place(relx=0.5,rely=0.2,relwidth=0.25,relheight=0.2)
        #
        self.lbExit_admission_time = Label(self,text="出场时间",fg='black',font=('微软雅黑',16))
        self.lbExit_admission_time.place(relx=0.75,rely=0,relwidth=0.25,relheight=0.2)
        #
        self.etExit_admission_time = Label(self,fg='black',font=('微软雅黑',18),state='disabled')
        self.etExit_admission_time.place(relx=0.75,rely=0.2,relwidth=0.25,relheight=0.2)
        #
        self.lbExit_time_consuming = Label(self,text="停车耗时",fg='black',font=('微软雅黑',16))
        self.lbExit_time_consuming.place(relx=0.5,rely=0.4,relwidth=0.25,relheight=0.2)
        #
        self.etExit_time_consuming = Label(self,fg='black',font=('微软雅黑',18),state='disabled')
        self.etExit_time_consuming.place(relx=0.5,rely=0.6,relwidth=0.25,relheight=0.2)
        #
        self.lbExit_Payable = Label(self,text="应收金额",fg='black',font=('微软雅黑',16))
        self.lbExit_Payable.place(relx=0.75,rely=0.4,relwidth=0.25,relheight=0.2)
        #
        self.etExit_Payable = Label(self,fg='black',font=('微软雅黑',18),state='disabled')
        self.etExit_Payable.place(relx=0.75,rely=0.6,relwidth=0.25,relheight=0.2)
        #
    ...
    def ok(self):
        self.numbername=self.etExit_number_plate.get()
